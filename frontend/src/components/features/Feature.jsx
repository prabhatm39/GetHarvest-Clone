  ...
  return (
    ...
    <Box  width={"90%"} margin="auto"  >
     ...
     <Box display={"flex"} alignItems="center" mt="10%" ref={timer} >
        <Box >
            <Text align={"left"} color="#fb701e" style={{fontSize:"38px", fontWeight:"500"}}>Time tracking</Text>
            ...
            <Button color={"white"} bg="#fa5d00" borderRadius={"10px"} mt={"10%"} _hover={{bgColor:"rgba(250,93,0,90%)",borderColor:"rgba(250,93,0,90%)"}} onClick={signUp} style={{padding:"1rem 2rem"}}>Start your free trial</Button>
        </Box>
        <Box border={"1px solid black"}  >
            <img src="https://www.getharvest.com/hs-fs/hubfs/screenshot-features-timesheets.png?width=1181&name=screenshot-features-timesheets.png" alt="" style={{height:"30rem",width:"50rem"}} />
        </Box>
    ...
    <Box borderY={"1px solid red"} mt="10%"  >
     <Box display={"flex"} alignItems="center" mt="10%" ref={report} >
        <Box ml="15px">
            <Text align={"left"} color="#fb701e" style={{fontSize:"38px", fontWeight:"500"}}>Reports & analysis</Text>
            ...
            <Button color={"white"} bg="#fa5d00" size="lg" borderRadius={"10px"} mt={"10%"} _hover={{bgColor:"rgba(250,93,0,90%)",borderColor:"rgba(250,93,0,90%)"}} onClick={signUp} style={{padding:"1rem 2rem"}}>Start your free trial</Button>
        </Box>
        <Box border={"1px solid black"}  >
            <img src="https://www.getharvest.com/hs-fs/hubfs/screenshot-features-projects.png?width=1181&name=screenshot-features-projects.png" alt="" style={{height:"30rem",width:"50rem"}} />
        </Box>
    ...
    <Box  mt="10%" borderTop={"1px solid red"}   >
     ...
     <Box display={"flex"} alignItems="center" mt="10%" ref={invoice} >
        <Box >
            <Text align={"left"} color="#fb701e" style={{fontSize:"38px", fontWeight:"500"}}>Invoicing & <br/> payments</Text>
        ...
        <Box border={"1px solid black"}  >
            <img src="https://www.getharvest.com/hs-fs/hubfs/screenshot-features-invoices-1.png?width=1181&name=screenshot-features-invoices-1.png" alt=""  style={{height:"30rem",width:"50rem"}}  />
        </Box>
