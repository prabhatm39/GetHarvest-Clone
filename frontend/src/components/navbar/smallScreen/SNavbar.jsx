...
import styles from './snavbar.module.css';
...
const SNavbar = () => {
  ...
  return (
    <>      
      <Flex display={isLargerThan1000? 'none': 'flex'} justify="space-between" align="center" p="15" bgColor="#1d1e1c" className={styles.snav}>
          ...
          <DrawerBody>
            <Box lineHeight="7vh" fontWeight="bold" mb="5vh">
              <Box borderTop="1px solid #4a4b49">
                <ButtonLink1 to={'/why'} >Why Harvest?</ButtonLink1>
              </Box>
              <Box borderTop="1px solid #4a4b49">
                <ButtonLink1 to={'/feature'} >Features</ButtonLink1>
              </Box>
              <Box borderTop="1px solid #4a4b49">
                <ButtonLink1 to={'/coustomer'} >Customers</ButtonLink1>
              </Box>
              <Box borderTop="1px solid #4a4b49">
                <ButtonLink1 to={'/integrations'} >Integrations</ButtonLink1>
              </Box>
              <Box borderTop="1px solid #4a4b49" borderBottom="1px solid #4a4b49">
                <ButtonLink1 to={'/price'} >Pricing</ButtonLink1>
              </Box>
            </Box>
